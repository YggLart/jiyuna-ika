...
export default function Text(props) {
    ...
    return (
        <div className={"text " + props.className }>
            ...
            <p>Sed fermentum ornare porttitor. Morbi non mauris mi. Fusce metus orci, placerat vel libero sit amet, ornare porttitor neque. Donec convallis, mi quis hendrerit sagittis, tellus augue accumsan turpis, nec vehicula risus metus vulputate leo. Nam odio orci, mollis quis mattis in, venenatis id metus.</p>
        </div>
    )
} 